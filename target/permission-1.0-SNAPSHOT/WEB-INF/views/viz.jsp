...
<button id="sample_1_btn" disabled>自定义模型</button>
<button id="sample_3_btn" disabled>数据库抽取模型</button>
<br>
...
<p>
    ...
    <button id="generate_btn" disabled style="font-size: 120%"><b>生成图</b>
        <!-- The "update"  -->
    </button>
...
<script language="javascript" type="text/javascript" src="./scripts/site.js"> </script>
